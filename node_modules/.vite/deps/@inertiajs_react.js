...
<Link href="${p}" method="${a}" as="button">...</Link>`), (0, import_react6.createElement)(c, { ...w2, ...c === "a" ? { href: p } : {}, ref: I2, onClick: R2 }, l);
});
...
function W2(l, c) {
  ...
  let v2 = (0, import_react7.useCallback)((t, o, n = {}) => {
    let C2 = { ...n, onCancelToken: (m) => {
      ...
      if (x(false), I2(false), clearTimeout(P.current), n.onBefore)
        return n.onBefore(m);
    }, onStart: (m) => {
      if (T(true), n.onStart)
        return n.onStart(m);
      ...
      if (s.current && (T(false), h(null), e({}), r(false), x(true), I2(true), P.current = setTimeout(() => {
        s.current && I2(false);
      }, 2e3)), n.onSuccess)
    ...
    t === "delete" ? Oe.delete(o, { ...C2, data: R2(u2) }) : Oe[t](o, R2(u2), C2);
  }, [u2, e]);
